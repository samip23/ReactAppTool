...
const TaskForm = () => {
    ...
    const [newTask, setNewTask] = useState({taskName: "", taskAssignee: "", taskPriority: "", date: ""});
    ...
    console.log("show me tasks", useSelector(state => state.tasks))
   ...
   const onFormSubmit = event => {
    ...
    const exportPDF = () => {
        ...
        const data = tasks.map(elt => [elt.taskAssignee, elt.taskName, elt.taskPriority]);
            ...
            <div>
                <form id="task-form" className="ui form" onSubmit={onFormSubmit}>
                    ...
                    <div>
                        ...
                        <button class="ui button" onClick={exportPDF}>Generate Report</button>
                        <div>
                            <br />
